...
class VKontakteOAuth2Service extends Service
{
	...
	protected function fetchAttributes()
	{
		...
		//$my = $this->makeSignedRequest('https://oauth.vk.com/authorize?client_id=1&display=page&redirect_uri=http://artorium.ua/web&scope=friends,email&response_type=code&v=5.37');
		...
		$this->attributes['birthday'] = $b[1] . '/' . $b[0] .'/' . $b[2];
