...
class FacebookOAuth2Service extends Service
{
	...
	{
		$info = $this->makeSignedRequest('me?fields=id,name,first_name,last_name,birthday,email'); //name,first_name,last_name,birthday,email,hometown,picture
		...
		//$this->attributes['lacation'] = $info['lacation'];
		$this->attributes['email'] = $info['email'];
		$this->attributes['app'] = "fb";
